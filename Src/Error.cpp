...
std::string Error::what() throw()
{
    ...
    switch(this->m_level)
    {
        case level::WARNING: str= print<unix_color::GREEN>("WARNING"); break;
        case level::ERROR: str= print<unix_color::BLUE>("ERROR"); break;
        case level::FATAL_ERROR: str= print<unix_color::RED>("FATAL ERROR"); break;
        default : str="WARNING";
    }
